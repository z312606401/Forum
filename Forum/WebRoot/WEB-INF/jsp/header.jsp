...
<style type="text/css">
	...
	.btn {
		background: #c7b985 url(/Forum_SSM/images/bg.png) 0 -200px repeat-x;
		color: #000000;
		border-width: 1px;
		padding-left: 15px;
		padding-right: 15px;
	...
	#header {
		width: 940px;
		margin: auto;
		background: url(/Forum_SSM/images/headerbg.png) 0 0 repeat-x;
	}
	/*toolbar*/
	.toptool {
		background: url(/Forum_SSM/images/bg.png) 0 0 repeat-x;
		color: #ffffff;
		padding-top: 5px;
	}
	...
	#infobox {
		...
		margin-top: -.8em;
		background: #c7b985 url(/Forum_SSM/images/bg.png) 0 bottom repeat-x;
	}
	...
	#notice a {
		color: #fff;
		padding-left: 1em;
		background: url(/Forum_SSM/images/dotB.png) no-repeat 0 .1em;
		margin-left: 1.5em
	}
	/*banner*/
	.banner img {
	...
	/*guide*/
	.guide {
		background: #F3F8EF url(/Forum_SSM/images/bg.png) 0 -100px repeat-x;
		padding: .5em;
		color: #ccc
	}
	...
	.h {
		...
		background: #E0F0F9 url(/Forum_SSM/images/bg.png) 0 -200px repeat-x;
		text-align: left;
		color: #000000;
		padding: .3em .4em
	}
	...
	/*table tr2*/
	.tr2 {
		background: #F3F8EF url(/Forum_SSM/images/bg.png) 0 -300px repeat-x;
		color: #dc565e;
	}
				...
				<tr>
					<td class="banner">
						<a href="<c:url value="category_list.do" />">
							<img src="/Forum_SSM/images/logo.png" ></img>
						</a>
					</td>
					<td class="banner" id="banner" align="right">
						<img src="/Forum_SSM/images/banner.gif"></img>
					</td>
				</tr>
				<tr>
